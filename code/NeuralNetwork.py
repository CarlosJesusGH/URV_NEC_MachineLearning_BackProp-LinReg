...
class NeuralNetwork(object):
    ...
    def __init__(self):
        ...
        self.momentum = 0
        self.batchSize = 0  # 0 means entire data
        # Other parameters
        self.trainDataFile = ''
    ...
    def trainNetwork(self, epochs, trainDataFile, useInteractivePlot):
        ...
        for i in range(self.epochs):
            yHatTrain, yTrain = self.forward(trainInput, trainOutput, self.batchSize)
            cost, results, percError = self.costFunction(yTrain, yHatTrain)
            ...
            yHatVal, yVal = self.forward(validateInput, validateOutput, 0)
            cost, results, percError = self.costFunction(yVal, yHatVal)
    ...
    def validateLearning(self, validateFile):
        ...
        yHat, y = self.forward(inputs, outputs, 0)      # paramBatchSize
